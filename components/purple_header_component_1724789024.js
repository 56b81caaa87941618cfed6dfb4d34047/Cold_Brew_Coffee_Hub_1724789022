...
<template>
  <header class="w-full z-30 bg-purple-900" id="header-section-container" style="min-height: 150px"  >
      ...
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <ul id="desktop-sign-in-links" class="flex-1 flex justify-end items-center">
          <li>
            <a
              id="sign-in-link"
              class="font-medium text-sm whitespace-nowrap transition duration-150 ease-in-out text-white hover:text-purple-200"
              href="signin.html"
            >
              Sign in
            </a>
          ...
          <li class="ml-6">
            <a
              id="sign-up-link"
              class="btn-sm transition duration-150 ease-in-out w-full group relative text-white hover:text-purple-200 bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-500 hover:to-pink-400 rounded-full px-4 py-2 shadow-lg"
              href="signup.html"
            >
        ...
        <div class="md:hidden flex items-center ml-4">
          ...
          >
            <ul id="mobile-nav-list" class="bg-purple-800 shadow-lg rounded-lg px-4 py-2">
              ...
              <li>
                <a id="mobile-Brewing Guide-link" class="flex font-medium text-sm py-2 text-white hover:text-purple-200" href="Brewing Guide.html">Brewing Guide</a>
              </li>
              <li>
                <a id="mobile-Shop-link" class="flex font-medium text-sm py-2 text-white hover:text-purple-200" href="Shop.html">Shop</a>
              </li>
              <li>
                <a id="mobile-About Us-link" class="flex font-medium text-sm py-2 text-white hover:text-purple-200" href="About Us.html">About Us</a>
              </li>
            </ul>
          </nav>
        </div>
